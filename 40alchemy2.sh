...
export RPC_ENDPOINTS_ARBT='https://arb-sepolia.g.alchemy.com/v2/m2D5RQi16aHnQRR_1kYorsd7fPi7_Atl'
export RPC_ENDPOINTS_BSSP='https://base-sepolia.g.alchemy.com/v2/m2D5RQi16aHnQRR_1kYorsd7fPi7_Atl'
export RPC_ENDPOINTS_BLSS='https://blast-sepolia.g.alchemy.com/v2/m2D5RQi16aHnQRR_1kYorsd7fPi7_Atl'
export RPC_ENDPOINTS_OPSP='https://opt-sepolia.g.alchemy.com/v2/m2D5RQi16aHnQRR_1kYorsd7fPi7_Atl'
