...
EXECUTOR_URL="https://github.com/t3rn/executor-release/releases/download/v0.24.1/executor-linux-v0.24.1.tar.gz"
EXECUTOR_FILE="executor-linux-v0.24.1.tar.gz"
