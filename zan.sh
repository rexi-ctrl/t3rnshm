...
EXECUTOR_FILE="executor-linux-v0.21.11.tar.gz"
...
export RPC_ENDPOINTS_ARBT="https://api.zan.top/node/v1/arb/sepolia/$ZAN"
...
export RPC_ENDPOINTS_OPSP="https://api.zan.top/node/v1/opt/sepolia/$ZAN"
